...
ball.o: ball.c ../../drivers/avr/system.h ../../drivers/display.h ../../drivers/navswitch.h ../../fonts/font5x7_1.h ../../utils/font.h ../../utils/pacer.h ../../utils/tinygl.h
	$(CC) -c $(CFLAGS) $< -o $@
...
main.out: main.o paddle.o ir_uart.o ball.o pio.o system.o timer.o display.o timer0.o usart1.o ledmat.o navswitch.o font.o pacer.o tinygl.o prescale.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
